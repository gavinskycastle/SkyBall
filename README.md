...
1. Clone the repository using Git. Execute this in a terminal: `git clone https://github.com/gavinskycastle/ScoreJam37.git`
2. Cd into ScoreJam37. `cd ScoreJam37`
...
8. Run a local web server and open the ScoreJam37.html

## Building (Linux/macOS)
 
1. Clone the repository using `git clone https://github.com/gavinskycastle/ScoreJam37.git`
2. Move to the ScoreJam37 directory `cd ScoreJam37`
...
8. Make the binary executable `chmod +x ScoreJam37`
9. Run the binary with `./ScoreJam37`
...
7. Run ScoreJam37.exe! You have just compiled ScoreJam37 for Windows using MinGW.
...
7. Go into Debug, your build of ScoreJam37 is there. You have now compiled ScoreJam37 for Windows using MSVC.
